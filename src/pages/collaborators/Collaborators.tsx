          ...
          <div className="max-w-[2000px] mx-auto lg:px-14 px-3 w-full">
            <div className="">
              ...
              <div className="grid md:grid-cols-3 gap-3">
                <a href="https://www.tempus.com/"  rel="noreferrer" target="_blank" >
...
<a href="https://www.moonpay.com/"  rel="noreferrer" target="_blank">
                <div className="border border-[#404040] rounded-[12px] h-[250px] p-1 flex flex-col justify-between">
                  <div className="flex flex-1 justify-center items-center">
                ...
                <a href="https://verily.com/"  rel="noreferrer" target="_blank">
...
<a href="https://ouraring.com/"  rel="noreferrer" target="_blank">
                <div className="border  border-[#404040] rounded-[12px] h-[250px] p-1 flex flex-col justify-between">
                  <div className="flex flex-1 justify-center items-center">
...
<a href="https://lapetussolutions.com/"  rel="noreferrer" target="_blank">
                <div className="border  border-[#404040] rounded-[12px] h-[250px] p-1 flex flex-col justify-between">
                  <div className="flex flex-1 justify-center items-center">
                    <img
                      loading="lazy"
                ...
                <a href="https://ada.com/"  rel="noreferrer" target="_blank">
                <div className="border  border-[#404040] rounded-[12px] h-[250px] p-1 flex flex-col justify-between">
                  <div className="flex flex-1 justify-center items-center">
